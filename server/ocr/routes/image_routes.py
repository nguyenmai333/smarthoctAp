...
from models import ImageResponse, TextDetectionResponse
from db import images_collection, texts_collection
import os
...
@router.post('/detect-text/{image_id}', response_model=TextDetectionResponse)
...
@router.get('/images', response_model=List[ImageResponse])  # Use List instead of list
